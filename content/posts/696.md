+++
title = "教程 | 白嫖党福音、资源汇总[解说更新完毕]"
date = "2023-01-04T18:29:00+08:00"
lastmod = "2026-01-04T23:14:26+08:00"
url = "/archives/696/"
typecho_cid = 696
typecho_slug = "696"
...
Collector_Mewtw0_QQ:1792901209，私人群号522645796，更新日期2022年9月16日。
更新内容：在线动画网站，部分插件升级，部分漫画app下载地址更新，下载工具扩展，部分图片搜索引擎更新。
**大伙不要随便转载此文，有什么后果我一律不负责**
...
绅士漫画 https://www.wnacg.org/ （支持在线H漫观看，PC端和手机端皆可，更新速度快，且全面，有打包下载功能，且支持网页保存+Picview插件批量打包，详情见插件版块）
...
https://www.sshs.club/ 、[https://www.hentaiclub.net/categ ... AC%A1%E5%85%83.html](https://www.hentaiclub.net/category/三次元.html)（谁爱看就看，有和琉璃神社差不多的月更合集）
...
文章里的中文json：
[https://raw.githubusercontent.co ... o-locale-zh_CN.json](https://raw.githubusercontent.com/YEWl/feedbro-locale/master/feedbro-locale-zh_CN.json)
...
[https://greasyfork.org/zh-CN/scr ... ernative-redirector](https://greasyfork.org/zh-CN/scripts/437291-open-source-alternative-redirector)，
（此处需要懂一点代码，也就增删查改一点点东西然后保存就完事了，他默认的是上面两个比较稳定的nitter，还有youtube和google也给你重定向了，不喜欢的可以删掉那几行代码）
附赠twi分析网站：https://en.whotwi.com/

说完了nitter，接下来到pixiv:https://www.pixiv.net/
...
轻之国度，一新一旧
[https://www.lightnovel.us](https://www.lightnovel.us/)
...
[https://github.com/tachiyomiorg/ ... sions/tree/repo/apk](https://github.com/tachiyomiorg/tachiyomi-extensions/tree/repo/apk)
...
Yandex搜图，https://yandex.com/images/（毛子的搜图有时堪比因果律武器、）
...
[https://docs.google.com/spreadsh ... x2daKM9M/edit#gid=0](https://docs.google.com/spreadsheets/d/1nbh_jvnh2FI6zKETbUqW97wOx0Qrlf0l0S-x2daKM9M/edit#gid=0)
...
YuC's AnimeList，https://yuc.wiki/（爷青回，向B站远古up主长门有C致敬）
...
鉴于有些同学不会解除B站脚本运用，此楼详细分析步骤。
此处以官方没有推荐使用的Edge作为例子，首先安装油猴（基本的）,安装以下两个脚本。
注意，一定要安装HTML5，别管浏览器是否有原生HTML5，装了再说。

装完了，来跳转，这里推荐 https://yuc.wiki/202210/

这里以新番“电锯人”为例：

来到这里，我们要选一个服务器：
举例，https://陈睿.我爱你
公共解析服务器的github网址，其实之前就已经给过了，在脚本的分类里，自己拿。
https://github.com/yujincheng08/BiliRoaming/wiki/公共解析服务器
注意，喜欢蹲更新的朋友，有时候可能会出现跳不进去的情况，这个时候请耐心等待，你选的服务器可能存在延迟。

楼主，琉璃神社有官方发布页么？迄今为止包括这楼给出的链接，我已经看到四个不同的链接了：
https://hacgapp.net/
https://hacg.mom/
https://llss.app/
https://hacg.cat/
...
https://www.hacg.me/index.html
大概是这个，其实不用担心，和南+差不多注册多点域名罢了，功能上没有什么差异。



https://www.acg.gy/ 这是发布页



[紧急更新]mangabz域名更换&屏蔽外网，不知道是怎么回事，日本节点上不了，域名也更换成https://mangabz.com/，去掉了前面的www.

[新内容更新] 拷貝漫畫域名拓展：https://www.copymanga.org/（org/site/info/net）
另外发现有非官方tachiyomi拷贝漫画的客户端，这里不方便透露
https://github.com/stevenyomi/copymanga



[新内容追加] tachiyomi非官方改版，更好的界面，更流畅的操作
https://github.com/Jays2Kings/tachiyomiJ2K
有点像以前的漫画控，下载完了自动关联官方本体，包括插件。



[新内容追加] 纯享版B站无评论无广告网页端脚本
参考某nga重定向写的
// ==UserScript==
// @ name          Bilibili Searchpage Redirector
// @ name:en-US      Bilibili Searchpage Redirector
// @ name:zh-CN      Bilibili简洁重定向
// @ description      Automatically redirect B domains to
// @ description:en-US  Automatically redirect B domains to
// @ description:zh-CN  自动重定向B域名
...
window.location.replace(location.href.replace(location.hostname, "www.bilibili.com/s"));

原理比较简单，B的所有视频都重定向到搜索版，在/video前面加/s就到了，油猴自己追加以上脚本就行了。注意：只针对有avbv号的视频，对番剧等无效。
奶头乐，相当于屏蔽了视频下方的评论，舒服

---
[REF][1]


  [1]: https://bgm.tv/group/topic/373032
